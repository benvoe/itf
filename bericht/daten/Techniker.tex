...
wurden. Jo's Workstation wurde am 20.11.2009 ausgetauscht \footnote{\fref{sec:pat_emails_1}}. Es kann daraus geschlussfolgert werden, dass die Dateien bereits vor dem Austausch in Jo's Besitz waren und die Dateien auf der verkauften Workstation  dementsprechend vermutlich von ihm stammen.
...
Steganographie-Bild \footnote{\fref{sec:charlie_daten_10}}. Die Inhalte der zip-Datei konnten auch
...
\footnote{\fref{sec:pat_emails_1}}, in der Terry erklärt, dass er sich um die Workstation kümmern wird, legt es den Schluss nahe, dass Terry für den Verkauf der Workstation verantwortlich ist.
